...
public class NoteReminderNotification {
    ...
    public static void notify(final Context context,
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                // Set ticker text (preview) information for this notification. and allows for reading using screen readers
                ...
                // adds additional action apart from Content Intent action involving tapping notification an takes user to mainActivity
                .addAction(
                        0,
                        "View all notes",
                        PendingIntent.getActivity(
