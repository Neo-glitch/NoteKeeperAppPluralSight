...
/**
 * simulate backing up of notes in mainActivity to a disk, but rather writing to logcat
 */
public class NoteBackup {
    ...
    public static void doBackup(Context context, String backupCourseId) {
        ...
        if(!backupCourseId.equals(ALL_COURSES)) {    // that means an exact CourseId was passed
